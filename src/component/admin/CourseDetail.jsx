...
function CourseDetail() {
  ...
  console.log(cart,"course details")
        ...
        <div className="border w-50 m-3 ">
          <div className="text-center">
            {!cart.courses.some((c) => c.courseId == course.courseId) ?
              ...
              }} style={{ width: "86%" }}> Add To Cart</button> :
              <button className="btn btn-danger mt-2  " onClick={()=>{
                let filteredItem=cart.courses.filter((c)=>c.courseId==course.courseId);
                dispatch(removeFromCart(filteredItem[0  ].id));
              }} style={{ width: "86%" }}> Remove From Cart</button>
